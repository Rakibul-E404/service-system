          ...
          return SingleChildScrollView(
            ...
            child: Column(
              children: <Widget>[
                ...
                // Subscription Option - Only for Providers
                Obx(() {
                    ...
                    return Column(
                      children: [
                        ProfileCommonTile(
                          ...
                          leadingIcon: const Icon(CupertinoIcons.creditcard_fill, color: Colors.grey),
                          title: 'Subscription',
                        ),
                        const SizedBox(height: AppSizes.md),
                      ],
...
///
///
/// todo::: removing the rating  from the 'user' and removing the report from the 'user+provider'
///
///
///
///
            ...
            child: Column(
              children: <Widget>[
                ...
                ProfileCommonTile(
                  ...
                  leadingIcon: const Icon(CupertinoIcons.gear_solid, color: Colors.blue),
                  title: 'Settings',
                ),
                ...
                ProfileCommonTile(
                  ...
                  leadingIcon: const Icon(Icons.logout_outlined, color: AppColors.primaryColor),
                  title: 'Logout',
                ),
              ],
            ),
