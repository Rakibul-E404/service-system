...
class SignInController extends GetxController {
  ...
  //       AppUrl.signInUrl,
  //       body: requestBody,
  //       isLogin: true, // Set to true for login requests
  //     );
  //
  //     debugPrint('───────────────────────────────────────');
  ...
  //         if (token != null) {
  //           await SecureStorageService().write(AppConstants.authToken, token);
  //         }
  //
  //         if (userRole != null) {
  ...
  //         }
  //
  //         // Save user data (optional - if you need it)
  //         if (user != null) {
  //           // You can save individual user fields if needed
  ...
  //         );
  //       } else {
  //         debugPrint('⚠️ Success flag is false or no data');
  //         Get.snackbar(
  //           'Error',
  //           message,
