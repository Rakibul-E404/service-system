...
class _SignInScreenState extends State<SignInScreen> {
  ...
  String get selectedRole => Get.arguments?['role'] ?? 'user'; // Default to 'user' if no role passed
              ...
              onPressed: () {
                ...
                if (selectedRole.toLowerCase() == 'user') {
                  Get.offAllNamed(
                    ...
                    arguments: {'role': selectedRole}, // Pass role to next screen
                  );
                } else if (selectedRole.toLowerCase() == 'provider') {
                  Get.offAllNamed(
                          ...
                          TextButton(
                            onPressed: () {
                              Get.toNamed(
                                ...
                                arguments: {'role': selectedRole}, // Pass role to forgot password
                              );
                            },
                            child: Text(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: signInController.isLoading.value
                              ...
                              if (_formKey.currentState!.validate()) {
                                ...
                                // Don't clear fields here - only clear on successful login
                                // The controller handles navigation
                              }
                            },
                            ...
                            TextButton(
                              onPressed: () {
                                Get.toNamed(
                                  ...
                                  arguments: {'role': selectedRole}, // Pass role to sign up
                                );
                              },
                              child: Text(
                                AppStrings.signUp,
...
///
///
/// todo:: adding the social button for google
///
///
///
///
