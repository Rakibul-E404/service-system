...
class ServiceCard extends StatelessWidget {
  ...
  // 👇 Updated: author-related fields are now optional
  ...
  const ServiceCard({
    ...
    required this.location,
    required this.rating,
    this.authorId,       // Now optional
    this.authorName,     // Now optional
    this.authorImage,
    this.authorLocation,
    this.authorRating,
    this.onTap,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    // Location + Rating Row (conditionally rendered)
                    if (showLocationAndRating)
                      Row(
                        children: <Widget>[
                          Icon(Icons.location_on_outlined, size: 14, color: Colors.grey[500]),
                          ...
                          const SizedBox(width: 8),
                          Icon(Icons.star, size: 14, color: const Color(0xffed9d34)),
                          const SizedBox(width: 2),
                          Text(
                            rating.toString(),
                            style: TextStyle(
                    ...
                    // 👇 Optional: show author info compactly under the service
