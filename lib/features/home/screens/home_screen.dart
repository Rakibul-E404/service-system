            ...
            children: <Widget>[
              ...
              Obx(() {
                ...
                if (bannerImages.isEmpty) {
                  // Return a placeholder container instead of text
                  return Container(
                    height: 200,
                    decoration: BoxDecoration(
                ...
                // Show banners in carousel
                return ImageSlider(
                  imgList: bannerImages,
                  height: 200,
                  onImageTap: (int index) {
                    // Optional: You can add navigation logic here
                    // For example, if banners are linked to categories
                    debugPrint('Banner $index tapped');

                    // If you want banners to navigate to categories,
                    // you'll need to store category IDs with banners
                  },
                );
              }),
              // ================ END BANNER SECTION ================
