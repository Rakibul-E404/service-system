...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Map to associate image indices with search terms
    final Map<int, String> imageIndexToSearchMap = {
      0: 'Home Cleaning',
            ...
            children: <Widget>[
              ...
              ImageSlider(
                ...
                onImageTap: (int index) {
                  // Get search text based on tapped image index
                  final searchText = imageIndexToSearchMap[index] ?? 'Services';

                  debugPrint('🎯 Image tapped at index: $index');
                  debugPrint('📋 Setting search text to: $searchText');

                  // Navigate to search screen with search text
                  Get.toNamed(
