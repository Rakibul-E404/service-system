          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: <Widget>[
                ...
                // Show loading indicator at bottom when refreshing with existing data
                Obx(() {
                  return controller.isLoading.value && controller.notifications.isNotEmpty
                      ? const Padding(
