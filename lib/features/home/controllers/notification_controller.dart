...
class NotificationController extends GetxController {
  ...
  RxList<dynamic> notifications = RxList<dynamic>(<dynamic>[]);
...
class NotificationController extends GetxController {
  ...
  // Add this property for auto-refresh
  ...
  void onReady() {
    super.onReady();
    // Auto-refresh when page is ready (alternative approach)
    if (isFirstLoad) {
  ...
  // Add this method for pull-down refresh
  ...
  // Update your fetchNotifications method to properly handle loading state
  Future<void> fetchNotifications() async {
    try {
      String? token = await _sharedPrefService.getAccessToken();
