...
import '../../../../core/utils/api/app_url.dart'; // Import AppUrl
...
class QuoteTab extends StatelessWidget {
  ...
  Widget _buildQuoteCard(BookingServiceModel quote) {
    // Build image URL - check if it's already a full URL or just a filename
    String imageUrl = '';
    if (quote.subCategory.image.isNotEmpty) {
      if (quote.subCategory.image.startsWith('http://') ||
        ...
        // Just a filename, prepend base URL
        imageUrl = '${AppUrl.imageBaseUrl}/${quote.subCategory.image}';
      }
    }

    debugPrint('🖼️ Image URL: $imageUrl'); // Debug print to check URL
