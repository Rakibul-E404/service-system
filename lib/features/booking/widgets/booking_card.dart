...
///
///
/// todo:::: adding the delte button for the fav item
///
///
///
///
...
class HorizontalServiceCard extends StatelessWidget {
  ...
  // Method to handle favorite deletion (tabIndex 3) - directly call onDelete
          ...
          children: <Widget>[
            ...
            Expanded(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                  // Show delete icon for Active Slot (tabIndex 0) or Favorites (tabIndex 3)
                  if (tabIndex == 0)
                    IconButton(
                      onPressed: () => _handleCancelBooking(context),
                      icon: Icon(
                    ...
                    IconButton(
                      onPressed: _handleDeleteFavorite,
                      icon: Icon(
                        Icons.delete,
                        color: Colors.red,
                        size: screenWidth * 0.07,
...
///
///
/// todo:::::: fixing the loading state for the ACTIVE SLOT
///
///
///
...
class HorizontalServiceCard extends StatelessWidget {
  ...
  void _performCancellation() async {
    ...
    try {
      ...
      // ✅ Show loading dialog with proper WillPopScope
      Get.dialog(
        WillPopScope(
          onWillPop: () async => false,
          child: const Center(
      ...
      // ✅ CRITICAL: Always close loading dialog after API call
      if (Get.isDialogOpen ?? false) {
      ...
      // ✅ CRITICAL: Close loading dialog if open
      if (Get.isDialogOpen ?? false) {
        Get.back();
      }
