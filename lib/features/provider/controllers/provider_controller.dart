...
class ProviderController extends GetxController {
  ...
  // Advertisement related observables (for UI only)
  RxInt activeAdsCount = 2.obs; // Hardcoded for UI
  RxList<Map<String, dynamic>> activeAds = <Map<String, dynamic>>[
    {
      'id': '1',
  ...
  // Simple UI methods for advertisements
