                    ...
                    () => Column(
                      children: <Widget>[
                        ...
                        _buildFormField(
                          ...
                          isEditing: controller.isEditing.value,
                          placeholder: 'Add a business category',
                        ),
                        ...
                        _buildFormField(
                          ...
                          isEditing: controller.isEditing.value,
                          placeholder: 'Add a business sub-category',
                        ),
                        ...
                        _buildFormField(
                          label: 'Advertising',
                          value: controller.advertising.value,
                          controller: controller.advertisingController,
                          isEditing: controller.isEditing.value,
                          placeholder: 'Add a business advertising',
                        ),
...
class ProviderProfilePage extends GetView<ProviderProfileController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(
            () => controller.isLoading.value && !controller.isEditing.value
            ? const Center(
          child: CircularProgressIndicator(),
        )
            : RefreshIndicator(
                    ...
                    children: <Widget>[
                      ...
                      Obx(
                          ...
                          children: <Widget>[
                            ...
                            // Current Image Display (View Mode)
                            if (!controller.isEditing.value &&
                                controller.businessImage.value.isNotEmpty)
                              Container(
                                width: double.infinity,
                                height: 200,
                                decoration: BoxDecoration(
