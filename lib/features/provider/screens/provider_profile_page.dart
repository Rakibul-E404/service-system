                      ...
                      children: <Widget>[
                        ...
                        Obx(
                            ...
                            children: <Widget>[
                              ...
                              // Show current image in both view and edit modes
                              ...
                              // Show upload options only in edit mode
                              if (controller.isEditing.value)
                                Column(
                                  children: <Widget>[
                                    // Show selected image preview or upload prompt
                                    GestureDetector(
                        ...
                        Obx(() => Column(
                          ...
                          children: <Widget>[
                                  ...
                                  if (controller.isEditing.value)
                                    Positioned(
                                      ...
                                      child: ElevatedButton.icon(
                                        ...
                                        label: Text(
                                          controller.isUploadingImage.value ? 'Uploading...' : 'Change Image',
                            ...
                            if (controller.businessImage.value.isEmpty) ...[
                              GestureDetector(
                                onTap: controller.isEditing.value && !controller.isUploadingImage.value
                                    ? () => controller.showImagePickerDialog()
                                    : null,
                                child: Container(
                                  width: double.infinity,
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(12),
                                    border: Border.all(
                                      color: controller.isEditing.value ? Colors.amber[600]! : Colors.grey[300]!,
                                  ...
                                  child: controller.isUploadingImage.value
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        CircularProgressIndicator(),
                                        SizedBox(height: 16),
                                        Text('Uploading image...', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500)),
                                      ],
                                    ),
                                  )
                                      : Column(
                                    ...
                                    children: [
                                      Icon(
                                        controller.isEditing.value ? Icons.add_photo_alternate : Icons.image_not_supported,
                                        size: 60,
                                        color: Colors.grey[400],
                                      ),
                                      const SizedBox(height: 16),
                                      Text(
                                        controller.isEditing.value ? 'Tap to add business image' : 'No business image',
                                        style: TextStyle(fontSize: 16, color: Colors.grey[600], fontWeight: FontWeight.w500),
                                      ),
                                      if (controller.isEditing.value) ...[
                                        const SizedBox(height: 8),
                                        Text('JPEG, PNG • Max 25 MB', style: TextStyle(fontSize: 12, color: Colors.grey[500])),
                                      ],
                                    ],
                                  ),
                                ),
                              ...
                              if (controller.isEditing.value && !controller.isUploadingImage.value) ...[
                                ...
                                SizedBox(
                                  ...
                                  child: ElevatedButton.icon(
                                    ...
                                    label: const Text('Upload Business Image', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                                  ),
                                ),
                              ],
                            ],
