...
class ProviderQuoteController extends GetxController {
  ...
  var bookings = <Map<String, dynamic>>[].obs;
  var errorMessage = ''.obs;
  var processingIds = <String>[].obs; // Track which bookings are being processed
  ...
  Future<void> respondToBooking(String bookingId, String status) async {
    try {
      processingIds.add(bookingId); // Mark as processing
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true) {
          ...
          // Remove the booking from the list after successful response
      ...
      processingIds.remove(bookingId); // Remove from processing
    }
  }
...
class _ProviderServicesScreenState extends State<ProviderServicesScreen>
  ...
  //         children: [
  //           // Top part with image and basic info
  //           Row(
  //             crossAxisAlignment: CrossAxisAlignment.start,
  //             children: [
  //               // Service Image
  ...
  //           const SizedBox(height: AppSizes.md),
  //           // Bottom part with provider info and action buttons
  //           Row(
  //             children: [
  //               // Provider Info
  //               CircleAvatar(
  ...
  Widget _buildQuoteCard(Map<String, dynamic> booking) {
    ...
    final serviceImagePath = booking['image'] ?? authorImagePath; // Fallback to author image if service image not available

    // Service Image URL
    final serviceImageUrl = (serviceImagePath != null && serviceImagePath.toString().isNotEmpty)
        ? 'https://d7001.sobhoy.com/${serviceImagePath.toString().replaceFirst(RegExp(r'^/'), '')}'
        : 'https://via.placeholder.com/150';

    // Provider Image URL
    final providerImageUrl = (authorImagePath != null && authorImagePath.toString().isNotEmpty)
        ? 'https://d7001.sobhoy.com/${authorImagePath.toString().replaceFirst(RegExp(r'^/'), '')}'
        : 'https://via.placeholder.com/150';
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      ...
                      onError: (exception, stackTrace) {
                        ...
                        print('❌ Failed to load service image: $serviceImageUrl');
                      },
                    ),
                  ),
                ),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      ...
                      fit: BoxFit.cover,
                      onError: (exception, stackTrace) {
                        print('❌ Failed to load provider image: $providerImageUrl');
                      },
                    ),
                  ),
                ),
            ...
            Expanded(
              child: TabBarView(
                ...
                children: [
                  ...
                  // 🔹 Quote Tab - With Approve/Cancel buttons
