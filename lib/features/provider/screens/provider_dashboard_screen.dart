            ...
            () => Stack(
              children: [
                ...
                if (controller.showAdCreationScreen.value)
                  Positioned(top: 0, left: 0, right: 0, bottom: 0, child: AdCreationScreen()),
              ],
            ),
          ),
        ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text('Tap to remove', style: TextStyle(fontSize: 12, color: Colors.grey.shade600)),
              ],
            ),
          ),
          IconButton(
...
///
///
/// todo::: fixing the to get teh profile informations
///
///
///
///
    ...
    return Scaffold(
      body: SafeArea(
        child: RefreshIndicator(
          onRefresh: () async {
            await controller.refreshData();
            await profileService.refreshProfile(); // Refresh profile data too
          },
          child: Obx(
                () => Stack(
              children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            ProfileCommonTile(
                              onTap: () {
                                profileService.setProviderProfileMode(true); // Set provider mode
                                Get.toNamed(AppRoutes.providerProfileRoute);
                              },
                              leadingIcon: const Icon(
                                CupertinoIcons.profile_circled,
...
///
///
/// todo::: fixign the avality button dependency on the api instead of the controller
///
///
///
...
class ProviderDashboardScreen extends GetView<ProviderController> {
      ...
      body: SafeArea(
        child: RefreshIndicator(
          ...
          child: Stack(
            children: [
              SingleChildScrollView(
                // Remove physics from Obx - wrap only the content that needs it
                child: Column(
                  children: <Widget>[
                    const ProviderTopBar(),
                    Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          // Active Advertisements Section - Wrap only this part with Obx
                          _buildAdsSection(),
              ...
              // Ad Creation Screen Overlay - Only wrap this with Obx
              Obx(() {
                if (controller.showAdCreationScreen.value) {
                  return Positioned(
                    top: 0,
  ...
  // // Fixed Availability Switch Widget
  // Widget _buildAvailabilitySwitch() {
  //   return Obx(() {
  //     final bool isAvailable = controller.isAvailable;
  //     final bool isUpdating = controller.isUpdatingAvailability.value;
  //
  //     return Container(
  //       padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 8.0),
  //       decoration: BoxDecoration(
  ...
  //                 fontSize: 16,
  //                 color: Colors.black,
  //                 fontWeight: isUpdating ? FontWeight.normal : FontWeight.w400,
  //               ),
  //             ),
  //           ),
  //           if (isUpdating)
...
// Add the AdCreationScreen class as a private class within the same file
