...
// lib/core/utils/api/app_url.dart

class AppUrl {
  AppUrl._();

  static const String baseUrl = 'https://d7001.sobhoy.com/api/v1'; // ✅ No trailing spaces
  static const String imageBaseUrl = 'https://d7001.sobhoy.com';   // ✅ No trailing spaces
