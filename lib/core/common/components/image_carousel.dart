...
///
///
/// todo:: showing the banner image perfectly
///
///
///
///
...
//               return Stack(
//                 children: <Widget>[
//                   // Main change: Remove horizontal padding from the image container
//                   Container(
//                     margin: const EdgeInsets.symmetric(horizontal: 0), // Keep the outer margin
//                     child: ClipRRect(
//                       borderRadius: BorderRadius.circular(widget.borderRadius),
//                       child: SizedBox(
...
//                           fit: BoxFit.cover, // This will cover the area without cutting
